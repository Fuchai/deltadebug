...
1) Visit http://bit.do/find-091557f6?entry.594570799=MjU4OTJhOW to read the simplified
bug report specific to this error find6.
...
/root/Desktop/find6/test/test.sh /root/Desktop/find6/find
...
http://bit.do/find-091557f6?entry.594570799=MjU4OTJhOW and click 'Next'.
...
http://bit.do/find-091557f6?entry.594570799=MjU4OTJhOW .

--> Execute /root/Desktop/find6/find/../diff.sh and copy the contents of
/root/Desktop/find6/find/../find6.patch to the field provided in the questionnaire.

--> Execute /root/Desktop/find6/find/../restore.sh to undo all changes if you have
any troubles and want to start anew.

--> Execute make in the folder /root/Desktop/find6/find to compile the program after
it was changed.
